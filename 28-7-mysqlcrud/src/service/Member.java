...
public class Member {
	...
	public String getMember_name() {//전역변수 값을 리턴
		return member_name;
	}
	public void setMember_name(String member_name) {//매개변수에 입력된 값을 전역변수에 저장함.
		this.member_name = member_name;
	}
	public int getMember_age() {//전역변수 값을 리턴
		return member_age;
	}
	public void setMember_age(int member_age) {//매개변수에 입력된 값을 전역변수에 저장함.
